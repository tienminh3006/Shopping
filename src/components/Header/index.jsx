        ...
        <div className={"header-with-search"}>
          ...
          <div className={"header__account"}>
            ...
            <div className={"header__account__login"}>
              <button className={"header__account__btn"}>Đăng nhập</button>
              <button className={"header__account__btn"}>Tạo tài khoản</button>
              <button
                className={"header__account__btn header__account__btn__google"}
              >
                <span>
          ...
          <div className={"header__cart"}>
            <span className={"header__cart__wrapper"}>
              <img
                ...
                alt="cart"
              />
              <span className={"header__cart__quantity"}>{cartItemCount}</span>
            </span>
